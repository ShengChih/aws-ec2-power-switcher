...
def parse_args():  # pragma: no cover
    ...
    parser.add_argument(
        ...
        dest="use_reloader",
        action="store_false",
        help="if the flask wsgi server reloading, then it cause vscode debug be interruptted!"
    )
...
def serve(cwd, app, port=5000, host="localhost", threaded=True, processes=1, ssl=False, ssl_keys=None, use_reloader=True):
